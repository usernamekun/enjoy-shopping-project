...
export default {
  components:{
    ...
    mounted(){
      ...
      // this.pid = pubsubs.subscribe('deletetodo',this.deletetodo)
...
<style>
  ...
  .btn-edit {color: #fff;background-color: skyblue;border: 1px solid rgb(92, 200, 243);margin-right: 7px;}
  .btn-danger:hover {color: #fff;background-color: #bd362f;}
  .btn-edit:hover {color: #fff;background-color: rgb(28, 180, 240);}
