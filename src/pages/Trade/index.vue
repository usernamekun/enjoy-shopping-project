  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div
        ...
        v-for="(addre, index) in address"
        :key="addre.id"
      >
        <span class="username" :class="{ selected: addre.isDefault == 1 }">{{
          addre.consignee
        }}</span>
        <p>
      ...
      <div class="detail">
        ...
        <ul
          class="list clearFix"
          v-for="arrayList in detailArrayList"
          :key="arrayList.id"
        >
          <li>
  ...
  export default {
    ...
    methods:{
      ...
      async submitOrder(){
        ...
        let data = {consignee:this.userDefaultAddress.consignee,
